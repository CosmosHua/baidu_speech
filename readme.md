This package is python package for ROS speech, which use **online** baidu speech to do TTS and speech recognition. This code is run well in ubuntu 14.04, thinkpad T44s.
